...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            arrayCompare: function (b, a) {
                ...
                for (var b = [].concat(b), a, e = [], d = 0; d < b.length; d++) if (a = b[d]) /@import|[{}]/.test(a) ? e.push("<style>" + a + "</style>") : e.push('<link type="text/css" rel=stylesheet href="' + a + '">');
                return e.join("")
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, c = function (b, a) {
                ...
                table: 1,
                ul: 1
            }, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, j = {}, l = {"#": 1},
        ...
        a(c, {
            $block: a({audio: 1, dd: 1, dt: 1, li: 1, video: 1}, e, i),
            $blockLimit: {
                article: 1,
                aside: 1,
                audio: 1,
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getTabIndex: CKEDITOR.env.ie ? function () {
                ...
                var b = (this.$.offsetHeight || this.$.offsetWidth) && this.getComputedStyle("visibility") != "hidden",
                    a, c;
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var i =
                            this.$.getBoundingClientRect(), m = d.$.documentElement, n = m.clientTop || j.$.clientTop || 0,
                        r = m.clientLeft || j.$.clientLeft || 0, p = true;
                    if (CKEDITOR.env.ie) {
        ...
        CKEDITOR.dom.element.prototype.getSize = function (b,
                                                           c) {
    ...
    (function () {
        function a(a, b) {
            ...
            d = c.endContainer;
            var r = c.startOffset, p = c.endOffset, g, h = this.guard, u = this.type,
                f = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var k = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    e = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(p) : d.getNext();
            ...
            if (a && !this._.guardRTL) {
                var F = n.type == CKEDITOR.NODE_ELEMENT ? n : n.getParent(),
                    D = n.type == CKEDITOR.NODE_ELEMENT ? r ? n.getChild(r - 1) : null : n.getPrevious();
        ...
        CKEDITOR.dom.walker.whitespaces = function (a) {
            return function (b) {
                var c;
                b && b.type == CKEDITOR.NODE_TEXT && (c = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && b.getText() == "â€‹");
                return !!(a ^ c)
            }
        };
    ...
    (function () {
        ...
        var f = function (a) {
                ...
                u: 1,
                "var": 1
            }, j = CKEDITOR.dom.walker.bogus(), l = new CKEDITOR.dom.walker.whitespaces,
            i = new CKEDITOR.dom.walker.bookmark, m = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var b = this.startContainer, c = this.endContainer, g = this.startOffset, h = this.endOffset,
                    d = this.collapsed, f, k;
                ...
                if (a.is2) {
                    var b = this.document.getByAddress(a.start, a.normalized), c = a.startOffset,
                        g = a.end && this.document.getByAddress(a.end, a.normalized), a = a.endOffset;
                    this.setStart(b, c);
                ...
                var c = this.startContainer, g = this.endContainer,
                    c = c.equals(g) ? a && c.type == CKEDITOR.NODE_ELEMENT && this.startOffset == this.endOffset - 1 ? c.getChild(this.startOffset) : c : c.getCommonAncestor(g);
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var v, o,
                            x = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                            I = function (a) {
                                var b = x(a);
                                b || (v = a);
                                return b
                ...
                if (!this.collapsed) {
                    var a = a || CKEDITOR.SHRINK_TEXT, g = this.clone(), h = this.startContainer, d = this.endContainer,
                        e = this.startOffset, f = this.endOffset, j = 1, i = 1;
            ...
            moveToPosition: function (a, b) {
                ...
                var b =
                    ...
                    c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), g = b.block, h = c.block, d = null;
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (a, c, d) {
                ...
                var d = [], g = !c && this._.rules, e = this._.transformations, k = f(this),
                    j = this.editor && this.editor.config.protectedSource, u = false;
        ...
        var s = {styles: 1, attributes: 1, classes: 1},
    ...
    (function () {
        CKEDITOR.lang = {
            languages: {
                ...
                var b = this.languages, c = c || navigator.userLanguage || navigator.language || a,
    ...
    CKEDITOR.ui.prototype = {
        add: function (a, c, b) {
            ...
            var c = this.items[a], b = c && this._.handlers[c.type],
                f = c && c.command && this.editor.getCommand(c.command), b = b && b.create.apply(this, c.args);
            this.instances[a] = b;
            f && f.uiItems.push(b);
    ...
    (function () {
        ...
        function n(a) {
            ...
            if (d) var e =
                    RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(e, ""),
                c = c + ("," + d);
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            remove: function () {
                ...
                var c = this.parent.children, b = CKEDITOR.tools.indexOf(c, this), f = a.previous = this.previous,
                    e = a.next = this.next;
                f && (f.next = a);
                e && (e.previous = a);
                c[b] = a;
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (e, d, j) {
            ...
            var g = new CKEDITOR.htmlParser,
                ...
                u = [], w = [], k = h, t = h.name == "textarea", F = h.name == "pre";
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                var a =
                        a.data, d = a.dataValue, d = t(d, b), d = g(d, G), d = p(d), d = g(d, I),
                    d = d.replace(Q, "$1cke:$2"), d = d.replace(E, "<cke:$1$2></cke:$1>"),
                    d = CKEDITOR.env.opera ? d : d.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
                    e = a.context || b.editable().getName(), f;
        ...
        var F = /(?:&nbsp;|\xa0)$/, D = "{cke_protected}", B = CKEDITOR.dtd,
            q = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            z = CKEDITOR.tools.extend({}, B.$blockLimit, B.$block),
            s = {elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]]}, A = {
        ...
        var o = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            G = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, C = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            Q = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            L = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, E = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, c = a.element, f = a.elementMode, m = a.fire("uiSpace", {space: "top", html: ""}).html,
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
            var f = this.container, n = this.ui.space("contents"),
    ...
    (function () {
        function a(a) {
            var c = a.editor, g = c.editable(), d = a.data.path, e = d.blockLimit, f = a.data.selection.getRanges()[0],
        ...
        function e(a) {
            var c, g = a.getRanges()[0], a = a.root, d = g.startPath(), e = {table: 1, ul: 1, ol: 1, dl: 1},
        ...
        var l = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
            i = CKEDITOR.dom.walker.whitespaces(true), m = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var n = function () {
            ...
            var k = CKEDITOR.dtd, m = {
                ...
                dl: 1,
                blockquote: 1
            }, l = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, n = CKEDITOR.tools.extend({}, k.$inline);
            delete n.br;
            return function (m, q, t) {
                ...
                if (!A.checkReadOnly()) {
                    var o = (new CKEDITOR.dom.elementPath(A.startContainer,
                        ...
                        mergeCandidates: [],
                        zombies: []
                    }, s = q.range, v = q.mergeCandidates, x, I, G, C;
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                var b = e.document, g = CKEDITOR.document, f = e.editable(), i = b.getBody(),
                    j = b.getDocumentElement(), p = f.isInline(), m;
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    if (n) {
                        ...
                        if (q) {
                            ...
                            j.setHtml("&#65279;");
                            j.insertBefore(i);
                            k && b.document.createText("ï»¿").insertBefore(i)
                        }
                        b.setStartBefore(i);
                        i.remove();
                        if (a) {
    ...
    (function () {
            ...
            if (b.collapsed) {
                ...
                for (l.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (l = 0); l;) {
                    ...
                    if (l.equals(m)) {
                        ...
                        var q = l.type, s = q == CKEDITOR.NODE_ELEMENT ? l.getName() : null,
                            r = s && l.getAttribute("contentEditable") == "false",
                            t = s && l.getAttribute("data-nostyle");
        ...
        function r(a) {
            var b = this._.definition, c = b.attributes, b = b.styles, d = t(this)[a.getName()],
        ...
        var B = {
                ...
                audio: 1,
                video: 1
            }, z = /\s*(?:;\s*|$)/, s = /#\((.+?)\)/g, A = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var c = this.$.parentNode, b = c.childNodes.length, f = this.getLength(), e = this.getDocument(),
                d = new CKEDITOR.dom.text(this.$.splitText(a), e);
    ...
    (function () {
        function a(a, c, e) {
            var d = a.serializable, j = c[e ? "endContainer" : "startContainer"], l = e ? "endOffset" : "startOffset",
...
*/
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this,
                            b, a, d, function () {
                                for (var f = [], d = [], g = a.id ? a.id + "_radio" : CKEDITOR.tools.getNextId() + "_radio", k = 0; k < a.items.length; k++) {
                                    var j = a.items[k], h = j[2] !== void 0 ? j[2] : j[0],
            ...
            if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
                ...
                a.on("load", function () {
                    ...
                    b = CKEDITOR.dom.element.createFromHtml('<div class="cke_resizer' +
                        b + " cke_resizer_" + k.lang.dir + '" title="' + CKEDITOR.tools.htmlEncode(k.lang.common.resize) + '" onmousedown="CKEDITOR.tools.callFunction(' + n + ', event )">' + ("ltr" == k.lang.dir ? "â—¢" : "â—£") + "</div>");
            ...
            exec: function (g) {
                ...
                if (c) {
                    ...
                    if (a == CKEDITOR.TRISTATE_OFF) {
                        ...
                        1 > e.length && (a = g.document.createElement(g.config.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), b = h.shift(), c.insertNode(a), a.append(new CKEDITOR.dom.text("ï»¿", g.document)), c.moveToBookmark(b), c.selectNodeContents(a), c.collapse(!0), b = c.createBookmark(), e.push(a), h.unshift(b));
                        d = e[0].getParent();
                        c = [];
    ...
    (function () {
        ...
        function z() {
            var a = new CKEDITOR.htmlParser.filter, b = {
                ...
                table: 1,
                ul: 1
            }, e = CKEDITOR.tools.extend({br: 0}, CKEDITOR.dtd.$inline), c = {
                p: 1,
                br: 1, "cke:br": 1
        ...
        function A(a, b, e) {
            ...
            var b = c.getHtml(),
                ...
                f = 0, b = b.replace(/<\/?p>/g, function (a) {
                    if ("<p>" == a) {
                        if (1 < ++f) return "</p><p>"
            ...
            $: function (a, b, c, h) {
                ...
                showBlock: function (a, b, c, h, g) {
                    ...
                    var d = this.element, a = this._.iframe,
                        a = CKEDITOR.env.ie ? a : new CKEDITOR.dom.window(a.$.contentWindow), j = d.getDocument(),
                        i = this._.parentElement.getPositionedAncestor(), n = b.getDocumentPosition(j),
                        j = i ? i.getDocumentPosition(j) : {x: 0, y: 0}, m = "rtl" == this._.dir,
                        f = n.x + (h || 0) - j.x, l = n.y + (g || 0) - j.y;
                    if (m && (1 == c || 4 ==
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                add: function (a) {
                    ...
                    var b = b || ("rtl" == this.editor.lang.dir ? 2 : 1), e = this.items, i = this.editor,
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, b, c) {
                ...
                render: function (a, b, c) {
                    var g = a.id + ("" +
                        b), e = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state,
            ...
            if (!1 !== a.resize_enabled) {
                ...
                b.on("uiSpace", function (a) {
                    if ("bottom" ==
                        ...
                        var c = '<span id="' + q + '" class="cke_resizer' + e + " cke_resizer_" + h + '" title="' + CKEDITOR.tools.htmlEncode(b.lang.common.resize) + '" onmousedown="CKEDITOR.tools.callFunction(' + p + ', event)">' + ("ltr" == h ? "â—¢" : "â—£") + "</span>";
                ...
                a.on("uiSpace", function (c) {
                    if (c.data.space == a.config.toolbarLocation) {
                        ...
                        var d = CKEDITOR.tools.getNextId(),
                            ...
                            d = !1 !== a.config.toolbarStartupExpanded, e, g;
            ...
            listToArray: function (c, j, f, b, i) {
                ...
                for (var e, h = c[f].parent.getDocument(), g = new CKEDITOR.dom.documentFragment(h), a = null, d = f, m = Math.max(c[f].indent, 0), k = null, n, l, p = b == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    ...
                    if (o.indent == m) {
                        ...
                        d++
                    } else if (o.indent == Math.max(m, 0) + 1) l = c[d - 1].element.getDirection(1), d = CKEDITOR.plugins.list.arrayToList(c, null, d, b, l != n ? n : null), !k.getChildCount() && (CKEDITOR.env.ie && !(7 < h.$.documentMode)) && k.append(h.createText("Â ")), k.append(d.listNode), d = d.nextIndex; else if (-1 == o.indent &&
                        !f && e) {
        ...
        function p(d, i) {
            ...
            this.allowedContent = {
                "div h1 h2 h3 h4 h5 h6 ol p pre ul": {
                    ...
                    classes: a ? d.config.indentClasses :
                        null
                }
            };
                        ...
                        if (!(1 > j.length)) {
                            ...
                            if (h && h.length) for (b = 0; b < h.length; b++) {
                                for (g = n = h[b]; (g = g.getNext()) && g.is && g.getName() in m;) CKEDITOR.env.ie && !n.getFirst(function (b) {
                                    return t(b) && u(b)
                                }) && n.append(l.document.createText("Â ")), n.append(g);
                                n.insertAfter(i)
                            }
                        }
                    }
                    ...
                    if (l) {
                        ...
                        if (!j && !h) {
                            if (a.is("li")) {
                                ...
                                (g = e.next()) && (g.type == CKEDITOR.NODE_ELEMENT && g.is("ul", "ol")) && (CKEDITOR.env.ie ? f.createText("Â ") : f.createElement("br")).insertBefore(g)
                            }
                            a &&
                            b.moveToElementEditStart(a)
                        } else {
    ...
    (function () {
        function j(a, b) {
            var d = {}, e = [], f = {nbsp: "Â ", shy: "Â­", gt: ">", lt: "<", amp: "&", apos: "'", quot: '"'},
    ...
    (function () {
        ...
        function p(a) {
            var e, f = a.config, p = f.floatSpaceDockedOffsetX || 0, o = f.floatSpaceDockedOffsetY || 0,
                u = f.floatSpacePinnedOffsetX || 0, q = f.floatSpacePinnedOffsetY || 0, i = function (c) {
                    function f(a, c, b) {
                        d.setStyle(c, s(b));
                    ...
                    if (r) {
                        ...
                        if (e) {
                            ...
                            var c = g.getViewPaneSize(), h = c.width / 2,
                ...
                }, f = CKEDITOR.document.getBody(), v = {id: a.id, name: a.name, langDir: a.lang.dir, langCode: a.langCode},
                ...
                renderHtml: function (a) {
                    ...
                    if (!this._.panel) {
                        var b = this._.panelDefinition, c = this._.panelDefinition.block,
                            h = b.parent || CKEDITOR.document.getBody(), g = "cke_combopanel__" + this.name,
                            e = new CKEDITOR.ui.floatPanel(a, h, b), f = e.addListBlock(this.id, c), d = this;
                        e.onShow = function () {
        ...
        CKEDITOR.plugins.add("justify",
            {
                init: function (a) {
                    if (!a.blockless) {
                        var c = new f(a, "justifyleft", "left"), b = new f(a, "justifycenter", "center"),
                            g = new f(a, "justifyright", "right"), d = new f(a, "justifyblock", "justify");
    ...
    (function () {
        ...
        var p = CKEDITOR.tools.extend, J = CKEDITOR.dom.element, A = J.createFromHtml, n = CKEDITOR.env,
            v = CKEDITOR.dtd, C = 128, V = 64, L = 32, F = 16, aa = 8, w = 4, x = 2, r = 1, D = "Â ", X = v.$listItem,
            fa = v.$tableContent, da = p({}, v.$nonEditable, v.$empty), S = v.$block, Y = 100,
        ...
        var h, j = {
            modes: {wysiwyg: 1, source: 1}, canUndo: !1, readOnly: 1, exec: function (a) {
                ...
                if (b.fullPage) g = a.getData().replace(/<head>/, "$&" + e).replace(/[^>]*(?=<\/title>)/, "$& &mdash; " + a.lang.preview.preview); else {
                    ...
                    g = a.config.docType +
                        '<html dir="' + a.config.contentsLangDirection + '"><head>' + e + "<title>" + a.lang.preview.preview + "</title>" + CKEDITOR.tools.buildStyleHtml(a.config.contentsCss) + "</head>" + (b + ">") + a.getData() + "</body></html>"
                }
                e = 640;
                b = 420;
                d = 80;
                try {
                    var c = window.screen, e = Math.round(0.8 * c.width), b = Math.round(0.7 * c.height),
    ...
    (function () {
        ...
        CKEDITOR.plugins.scayt = {
            engineLoaded: !1, instances: {}, controlInfo: {}, setControlInfo: function (a, c) {
                ...
                this.engineLoaded = -1;
                var c =
                        document.location.protocol, c = -1 != c.search(/https?:/) ? c : "http:",
        ...
        CKEDITOR.plugins.add("scayt", {
            requires: "menubutton,dialog", beforeInit: function (a) {
                ...
                a.contextMenu && a.addMenuItems && a.contextMenu.addListener(function (b, c) {
                    ...
                    if (!h) return null;
                    var i = l.getLang(),
                        m = a.config.scayt_contextCommands || "all", h = window.scayt.getSuggestion(h, i),
                        m = m.split("|"), n;
                    for (n in f) {
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("tab", {
            init: function (c) {
                for (var d = !1 !== c.config.enableTabKeyTools, e = c.config.tabSpaces || 0, b = ""; e--;) b += "Â ";
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("undo", {
            init: function (a) {
                ...
                var b = new i(a), e = a.addCommand("undo", {
                    exec: function () {
        ...
        i.prototype = {
            type: function (a) {
                var a = a && a.data.getKey(), c = a in k, d = this.lastKeystroke in k, b = c && a == this.lastKeystroke,
                    e = a in l, f = this.lastKeystroke in
                    l;

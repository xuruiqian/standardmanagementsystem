...
<div id="main">
    ...
    <form name=alipayment action=alipaytradepagepay method=post
          target="_blank">
    ...
    <form name=tradequery action=alipaytradequery method=post
          target="_blank">
    ...
    <form name=traderefund action=alipaytraderefund method=post
          target="_blank">
    ...
    <form name=traderefundquery
          action=alipaytradefastpayrefundquery method=post
          target="_blank">
    ...
    <form name=tradeclose action=alipaytradeclose method=post
          target="_blank">
